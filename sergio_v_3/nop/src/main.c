...
void draw_line(t_player *player, t_game *game, float start_x, int i)
{
    ...
    if(!DEBUG)
    {
        ...
        if (game->map[(int)(ray_y - sin_angle) / BLOCK][(int)ray_x / BLOCK] != '1')
            texture_index = 0;
        else if (game->map[(int)(ray_y + sin_angle) / BLOCK][(int)ray_x / BLOCK] != '1')
            texture_index = 1;
        else if (game->map[(int)ray_y / BLOCK][(int)(ray_x + cos_angle) / BLOCK] != '1')
            texture_index = 2;
        else if (game->map[(int)ray_y / BLOCK][(int)(ray_x - cos_angle) / BLOCK] != '1')
            texture_index = 3;
		/*if(dist_x > dist_y)
